...
<meta charset="utf-8">
<title>CATÁLOGO DE FORMATOS</title>
...
<div id="header" class="header">
    <table height="100%" width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="120" align="right" class="iconito"><img src="../imagenes/iconitos/_formatosI.png" height="40"></td>
        <td align="left" valign="middle"><span id="verMenu" style="cursor:pointer;">CATÁLOGO DE FORMATOS</span></td>
  ...
  <table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0" id="dataTablePrincipal" class="tablilla">
    <thead id="cabecera_tBusquedaPrincipal">
      <tr class="titulos_dataceldas">
        ...
        <th align="center">
        FORMATO
        <button id='addPacientePrincipal' onClick='nuevoPaciente()' class='ui-button ui-widget ui-corner-all ui-button-icon-only' title='Agregar un nuevo formato'><span class='ui-icon ui-icon-plus'>s</span></button>
        </th>
        <th align="center" nowrap>ÁREA</th>
      </tr>
    </thead>
    ...
    <tfoot> <tr>
        ...
        <td>
        <input name="sNota" id="sNota" type="text" placeholder="-Nombre del formato-" class="search_init" style="width:90%;" />
        </td>
        <td>
        <input name="sArea" id="sArea" type="text" placeholder="-Área-" class="search_init" style="width:90%;" />
        </td>
  </tr> </tfoot>
  </table>
</div>
