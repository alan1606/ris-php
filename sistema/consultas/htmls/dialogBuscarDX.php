...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="2" style="font-size:0.8em;" bgcolor="#BBB">
  <tr height="50%">
    <td>
    <table width="99%" cellspacing="0" id="dataTableBDX" height="100%" border="0" cellpadding="4" class="tablilla" bgcolor="#FFFFFF">
        <thead id="my_head">
          <tr>
    ...
    <table width="99%" cellspacing="0" id="dataTableDXS" height="100%" border="0" cellpadding="5" class="tablilla" bgcolor="#FFFFFF">
        <thead id="my_head">
          <tr>
            ...
            <th class="titulosTabs" align="center" width="1%">PRIMARIO</th>
