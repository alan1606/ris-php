    ...
    <div class="modal-content animated flipInY">
      ...
      <div class="modal-body">
		...
		<table width="100%" cellpadding="0" cellspacing="0">
            ...
            <li role="presentation" class="tab_consulta hide_nsv hide_nhc hide_dx hide_meds no_graf no_histo hsh" id="tab_add_cto">
							<a href="#tAddCto" aria-controls="tAddCto" role="tab" data-toggle="tab" id="mi_tab_add_cto">AGREGAR CONCEPTOS</a>
						</li>
					</ul>
				</td>
...
Sin embargo, en sentido estricto se suele denominar cardiopatía a las enfermedades propias de las estructuras del corazón.">enfermedad cardiovascular.</span></samp>
            ...
            <div role="tabpanel" class="tab-pane" id="tAddCto">
              <div class="row">
                    ...
                    <!-- Nav tabs -->
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="dropdown">
                          <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">ESTUDIOS <span class="caret"></span></a>
                          <ul class="dropdown-menu">
                            <li role="presentation" id="tab-imag"><a href="#tImagen" aria-controls="tImagen" role="tab" data-toggle="tab" id="tab_imgen">IMAGEN</a></li>
                            <li role="presentation" id="tab-labo"><a href="#tLab" aria-controls="tLab" role="tab" data-toggle="tab">LABORATORIO</a></li>
                          </ul>
                        </li>
                        ...
                        <li role="presentation" id="tab-farma"><a href="#tFarmacia" aria-controls="tFarmacia" role="tab" data-toggle="tab" id="t_farm">FARMACIA</a></li>
                        <li role="presentation"> <a href="#tResumen" aria-controls="tResumen" role="tab" data-toggle="tab">RESUMEN</a> </li>
                      </ul>
                      ...
                      <div class="col-sm-12 col-xs-12 col-md-12" align="left" id="aqui_productos"></div>
                          ...
                          <div role="tabpanel" class="tab-pane" id="tImagen"><br>
                            ...
                            <div class="row">
                                ...
                                -->
                                  <input type="hidden" name="medico_i" id="medico_i">

                              <div class="col-sm-12 col-xs-12 depende_medico_i">
                          ...
                          <div role="tabpanel" class="tab-pane" id="tLab"><br>
                            <div class="panel panel-primary hidden" id="new_med_ext1">
                              ...
                              -->
                                  <input type="hidden" name="medico_l" id="medico_l">

                              <div class="col-sm-12 col-xs-12 depende_medico_l">
                                  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
                                    <tr height="50%"> <td>
                                  ...
                                  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">
                                    <tr height="50%"> <td>
                                        <table width="100%" cellspacing="0" id="dataTableBproductos" height="100%" border="0" cellpadding="0" class="table table-striped table-hover table-bordered table-responsive">
                                          ...
                                          <tfoot align="center">
                                              <tr>
                                                  <th> <input type="text" name="te1" class="form-control input-sm" style="width:99%;" placeholder="Buscar"> </th>
                                                  <th> <input type="text" name="te2" class="form-control input-sm" style="width:99%;" placeholder="Buscar"> </th>
                                                  <th> </th>
