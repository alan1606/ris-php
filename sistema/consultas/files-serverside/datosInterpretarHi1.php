...
require("../../funciones/php/values.php");
 ...
 $idE = sqlValue($_POST["idE"], "int", $horizonte);
	...
	$result1 = mysqli_query($horizonte, "SELECT v.referencia_vc, v.interpretacion_vc, v.nota_interpretacion, date_format(v.fecha_venta_vc,'%d/%c/%Y'), v.id_paciente_vc, v.id_personal_medico_vc, v.id_concepto_es, v.usuarioEdo5_e, v.id_pacs, c.id_area_to, v.nota_radiologo_vc, v.usuarioEdo5_e, v.referencia_vc, DATE_FORMAT(v.fecha_venta_vc,'%Y%m%d'), c.id_area_to from venta_conceptos v left join conceptos c on c.id_to = v.id_concepto_es where v.id_vc = $idE ") or die (mysqli_error($horizonte));
