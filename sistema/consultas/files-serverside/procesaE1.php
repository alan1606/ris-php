...
if($_GET['action'] == 'listFotos1'){
    ...
    $query = mysqli_query($horizonte, "SELECT id_ie, nombre_ie, imagen_ie, a_reporte_ie, id_estudio_vc_ie FROM img_ultrasonido where id_estudio_vc_ie = $carpeta and tumb_ie = 1 and imagen_ie != 'NaN_1' and a_reporte_ie = 1 order by id_ie desc; ");
	while($rows = mysqli_fetch_assoc($query))
    {
		...
		if($rows['a_reporte_ie']==1){
			...
			<tr> <td>
			<img width="140" height="" onClick="miImg('.$img.',1)" style="border:1px solid black;cursor:pointer;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" />
			</td> </tr> </table>
            ';
			}else{
				echo  '
			...
			</td> </tr> <tr> <td><img width="140" height="" onClick="miImg('.$img.',1)" style="border:1px solid black;cursor:pointer;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" /></td> </tr> </table>
            ';
			}
		}else{
			$resultO = mysqli_query($horizonte, "SELECT estatus_vc from venta_conceptos where id_vc = ".$carpeta." limit 1") or die (mysqli_error($horizonte));
			...
			</td> </tr> <tr> <td><img width="140" height="" onClick="miImg('.$img.')" style="border:1px solid black;cursor:pointer;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" /></td> </tr> </table>
            ';
			}else{
				echo '
			<table class="table-condensed table-bordered" border="0" cellspacing="0" cellpadding="0" style="float:left"> <tr> <td>
	...
	switch($rowG1[0]){
		...
		case 3:
			...
			<tr> 
			<td align="center" valign="bottom" height="33.3%"><img id="myImg4" height="" style="border:1px solid black;" src="img_usg/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td> </tr>
			<tr> 
			...
			<tr> 
			<td align="center" valign="top" height="33.3%"><img id="myImg6" height="" style="border:1px solid black;" src="img_usg/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td> </tr> 
			</table>
			';
		break;
		case 4:
			...
			<tr> 
				<td width="50%" height="50%" align="center" valign="bottom"><img id="myImg7" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'.png?'.$x.'" /></td>
				<td height="" align="center" valign="bottom"><img id="myImg8" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img2[0].'.png?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="" align="center" valign="top"><img id="myImg9" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img3[0].'.png?'.$x.'" /></td>
				<td height="" align="center" valign="top"><img id="myImg10" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img4[0].'.png?'.$x.'" /></td> 
			</tr> 
			</table>
			';
		break;
		case 5:
			...
			<tr> 
				<td height="33.3%" align="right" valign="bottom"><img id="myImg11" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'.png?'.$x.'" /></td>
				<td height="33.3%" align="left" valign="bottom"><img id="myImg12" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img2[0].'.png?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="1%" align="right" valign="middle"><img id="myImg13" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img3[0].'.png?'.$x.'" /></td>
				<td height="1% align="left" valign="middle">
				<img id="myImg14" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img4[0].'.png?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="33.3%" align="center" valign="top" colspan="2"><img id="myImg15" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img5[0].'.png?'.$x.'" /></td>
			</tr> 
			</table>
			';
		break;
