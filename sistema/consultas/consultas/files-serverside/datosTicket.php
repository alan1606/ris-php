...
//Generales
 ...
 $resultA = mysqli_query("SELECT t_urgente_e_ov, t_entrega_domicilio_e_ov, t_toma_domicilio_e_ov, t_urgente_s_ov, t_aDomicilio_s_ov, gran_total_ov, total_real, ahorro, saldo_ov, abonado_ov, total_c from orden_venta where referencia_ov = '$rowR[0]' ") or die (mysqli_error($horizonte));
