...
$resultR = mysqli_query($horizonte, "SELECT margen_e_im, margen_p_im, no_temp_su from sucursales where id_su = $id_s") or die (mysqli_error($horizonte));
...
$resultMNE = mysqli_query($horizonte, "SELECT id_do, ext_do from documentos where aleatorio_do = $idSuc and que_es_do = 'MEMBRETE RESULTADOS IMAGENOLOGIA' and tipo_quien_do = 2 and nombre_do = 'ENCABEZADO'") or die (mysqli_error($horizonte));
...
$resultMNP = mysqli_query($horizonte, "SELECT id_do, ext_do from documentos where aleatorio_do = $idSuc and que_es_do = 'MEMBRETE RESULTADOS IMAGENOLOGIA' and tipo_quien_do = 2 and nombre_do = 'PIE'") or die (mysqli_error($horizonte));
...
<!-- <page backtop="27mm" backbottom="22mm" backleft="8mm" backright="7mm"> PARA TDI-->
