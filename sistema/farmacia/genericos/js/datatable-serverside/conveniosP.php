...
require("../../../Connections/horizonte.php");
	$now = date('Y-m-d');
	$aColumns = array('v.convenio_cv', 'DATE_FORMAT(c.fecha_expedicion_cvp,"%d/%c/%Y")', 'DATE_FORMAT(c.fecha_expiracion_cvp,"%d/%c/%Y")','c.id_cvp','c.id_cvp','c.id_cvp', 'concat(p.nombre_p," ", p.apaterno_p)', 'DATE_FORMAT(c.fecha_expiracion_cvp,"%Y-%c-%d")');
