...
require("../../../Connections/horizonte.php");
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		if($row[5]!=1){ $row[5] = "<div style='text-align:center;'> <img style='cursor:pointer;' src='../imagenes/generales/_eliminar.png' onClick='eliminarConvenio(this.id, this.lang);' id='$row[6]', lang='$row[0]' border = '0' width='22' /> </div>";}
		else{$row[5] = "";}
