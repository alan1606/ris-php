...
require("../../../../Connections/horizonte.php");
	$aColumns = array('m.nombre_generico_med', 'm.descripcion_med','m.cantidad_med', 'm.presentacion_med', 'm.nivel_med', 'm.grupo_med, m.id_med');
    ...
    // CONDITIONS 
    $sWhere = "WHERE (m.id_med between 1 and 80) " ;
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$row[0] = "<span lang='$row[6]'>$row[0]</span>";
