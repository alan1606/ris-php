...
if($_GET['idConvenio']==0){
	...
	$sWhere = "WHERE e.id_to not in ($lista) and e.id_tipo_concepto_to = 3 ";
}else{
	...
	$sWhere = "WHERE cb.id_cb not in ($lista) and c.id_tipo_concepto_to = 3 and cv.id_cv = '$_GET[idConvenio]' ";
}
