...
// consulta para sigma
	$obligatorio = 0;
	$aColumns = array('m.nombre_generico_med', 'm.descripcion_med', 'm.cantidad_med', 'm.presentacion_med', 'm.nivel_med', 'm.grupo_med', 'm.id_med', 'm.id_med');
	...
	if(isset($_GET['nombre'])){
			$sWhere = "where m.nombre_generico_med like '$_GET[nombre]' and m.id_med between 1 and 80 " ;	
	}
