...
require("../../../Connections/horizonte.php"); 
	...
	$aColumns = array('c.id_to', 'g.nombre_generico_med', 'c.concepto_to', 'g.cantidad_med', 'g.presentacion_med', 'g.via_administracion_med', 'g.nivel_med', 'g.grupo_med','c.costo_to','c.precio_to', 'c.precio_m', 'c.precio_m', 'c.id_to', 'c.id_to','c.id_to', 'c.id_to', 'c.id_to', 'c.id_to');
    ...
    $sIndexColumn = "c.id_to";
	 ...
	 // Joins   
	$sJoin = 'left join medicamentos g on g.id_med = c.id_medicamento_g';
	
	$sWhere = "where c.id_tipo_concepto_to = 5 and c.id_area_to = 61 ";
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$row[2] = "<span id='$row[12]' onClick='verMedicamento(this.id, $nombreP);' style='cursor:pointer; text-decoration:underline;'>$row[2]</span>";
