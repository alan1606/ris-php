...
<?php
	...
	if(isset($_GET['depto']) && $_GET['depto'] != 'x' && $_GET['depto'] != ''){//para las solicitudes con departamento
		if(isset($_GET['min']) && isset($_GET['max']) && $_GET['min'] != '' && $_GET['max'] != ''){
			$sWhere = "WHERE pa.usuario_pag = $id_user and pa.fecha_pag BETWEEN '$_GET[min]' AND '$_GET[max]' and pa.id_departamento_pag = '$_GET[depto]'";
		}else{$sWhere = "WHERE pa.usuario_pag = $id_user" ;}
	}else{
		if(isset($_GET['min']) && isset($_GET['max']) && $_GET['min'] != '' && $_GET['max'] != ''){
			$sWhere = "WHERE pa.usuario_pag = $id_user and pa.fecha_pag BETWEEN '$_GET[min]' AND '$_GET[max]'";
		}else{$sWhere = "WHERE pa.usuario_pag = $id_user" ;}
	}
