...
//Generales
 ...
 $resultR = mysqli_query($horizonte, "SELECT departamento_vc from venta_conceptos where referencia_vc = $ref and tipo_concepto_vc = 2 ") or die (mysqli_error($horizonte));
