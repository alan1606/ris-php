...
require("../../Connections/horizonte.php");
	$aColumns = array('u.nombre_u', 'u.apaterno_u','u.amaterno_u', 'u.usuario_u', 'u.id_u');
    ...
    $sIndexColumn = "u.id_u";
	 ...
	 // Joins   
	$sJoin = 'left join catalogo_puestos cp on cp.id_cp = u.idPuesto_u';//, sucursales s';
	 
    // CONDITIONS 
    $sWhere = "WHERE u.usuario_u != '' and u.usuario_u != 'AQUIENC' " ;
