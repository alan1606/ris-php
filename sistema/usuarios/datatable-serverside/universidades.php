...
require("../../Connections/horizonte.php"); 
	...
	$aColumns = array('u.id_e', 'u.clave_e', 'u.nombre_e', 'u.entidad_e', 'u.control_e', 'u.id_e');
     
    // DB tables to use 
    $aTables = array( 'catalogo_escuelas u');
    ...
    /* * Ordering */
    $sOrder = "  group by u.nombre_e ORDER BY u.nombre_e asc";
