...
require("../../Connections/horizonte.php"); 
	...
	$aColumns = array('c.id_to', 'c.concepto_to', 'c.precio_to','c.dias_entrega_to', 'c.id_to');
    ...
    // CONDITIONS
    $sWhere = "where c.id_tipo_concepto_to = 2 and c.descripcion_to = 'membresia_h'" ;
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		if($_GET['accesoU']==1){
			$row[1]= "<span class='text-info' style='cursor:pointer; text-decoration:underline;' id='$row[4]' lang='$row[1]' onClick='fichaEstudio(this.id, this.lang);'>$row[1]</span>";
		}
