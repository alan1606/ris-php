...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td>
    <ul>
        <li><a id="tabs-1-1" href="#tabs-1">AHF</a></li>
        <li><a id="tabs-2-1" href="#tabs-2">APNP</a></li>
        <li><a id="tabs-3-1" href="#tabs-3">APP</a></li>
        <li><a id="tabs-4-1" href="#tabs-4">AGO</a></li>
        <li><a id="tabs-5-1" href="#tabs-5">HISTORIAL</a></li>
    </ul>
    </td>
  ...
  <div id="tabs-1" style="width:97.5%; height:90%; color:;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="2" class="grisecito">
    <tr>
  ...
  <div id="tabs-2" style="width:97.5%; height:90%; color:;">
  ...
  <div id="tabs-3" style="width:97.5%; height:90%; color:;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="2">
    <tr>
  ...
  <div id="tabs-4" style="width:97.5%; height:90%; color:;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="2">
    <tr>
