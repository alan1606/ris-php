...
<div id="tabs_c" style="width:100%; height:99%;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    ...
    <ul style="font-size:0.8em;">
        <li><a class="tabs" id="tabs-1-1" href="#tabs-1" style="color:black; background-color:;">GENERALES</a></li>
        <li><a class="tabs" id="tabs-6-1" href="#tabs-6" style="color:black; background-color:;">S-V</a></li>
        <li><a class="tabs" id="tabs-2-1" href="#tabs-2" style="color:black; background-color:;">H-C</a></li>
        <li><a class="tabs" id="tabs-3-1" href="#tabs-3" style="color:black; background-color:;">DICTAMEN</a></li>
        <li><a class="tabs" id="tabs-4-1" href="#tabs-4" style="color:black; background-color:;">RECETA</a></li>
        <li><a class="tabs" id="tabs-5-1" href="#tabs-5" style="color:black; background-color:;">EXPEDIENTE</a></li>
    </ul>
    </td>
    <td align="right" style="padding-right:20px;">
    <button id="finalizarConsulta" style="font-size:0.8em;">Finalizar</button>&nbsp;
    <button id="salirSGconsulta" style="font-size:0.8em;">Salir sin guardar</button>
    <button id="imprimirReceta" style="font-size:0.8em;">Imprimir receta</button>
    </td>
  </tr>
</table>
  
  <div id="tabs-1" style="width:97.5%; height:90%;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td>
                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    <td class="titulosTabs" align="left" nowrap width="1%">Fecha última toma de signos</td>
                    <td width="120px"><input name="fechaSignosC" id="fechaSignosC" type="text" readonly></td>
  ...
  <div id="tabs-2" style="width:97.5%; height:90%;">
  ...
  <div id="tabs-3" style="width:97.5%; height:90%; color:black; font-size:0.8em;">
  ...
  <tr>
    <td id="contenedorDatatableDX">
      <table width="100%" height="100%" border="1" cellpadding="2" cellspacing="0" id="dataTableDX" class="dataTableB1" >
        <thead id="cabecera_tBusquedaDX" class="miCabeceraDT">
          <tr>
            <th style="color:white;" id="clickmeDX">#</th>
            <th style="color:white;">
            	DIAGNÓSTICO&nbsp;<button class="botonC busqueda" name="b_dictamenC" id="b_dictamenC"> </button>
            </th>
          </tr>
        </thead>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tr>
        <td align="left"class="titulosTabs"width="1%"nowrap valign="top">Nota médica</td>
        <td><textarea name="notaMedicaC" id="notaMedicaC" cols="1" rows="4" style="resize:none;height:110px;" onKeyUp="conMayusculas(this);"></textarea></td>
      </tr>
    </table>
    </td>
  </tr>
  ...
  <div id="tabs-4" style="width:97.5%; height:90%; color:black;"> 
  ...
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="contenedorDatatableMedicamentos">
      <table width="100%" height="100%" border="1" cellpadding="2" cellspacing="0" id="dataTableMedi" class="dataTableB1">
  ...
  <div id="tabs-5" style="width:97.5%; height:90%; color:black; font-size:0.8em; border:1px solid #999; background-color:white;"> 
  ...
  <ul style="font-size:0.8em;">
      <li><a class="tabs" id="tabs-1-1h" href="#tabs-1h" style="color:; background-color:;">CONSULTAS</a></li>
      <li><a class="tabs" id="tabs-2-1h" href="#tabs-2h" style="color:; background-color:;">IMAGEN</a></li>
      <li><a class="tabs" id="tabs-3-1h" href="#tabs-3h" style="color:; background-color:;">LABORATORIO</a></li>
      <li><a class="tabs" id="tabs-4-1h" href="#tabs-4h" style="color:; background-color:;">ENDOSCOPÍA</a></li>
      <li><a class="tabs" id="tabs-5-1h" href="#tabs-5h" style="color:; background-color:;">SERVICIOS</a></li>
  </ul>
  <div id="tabs-1h" style="width:99.5%; height:90%;">
  <table width="100%" height="93%" border="1" cellpadding="4" cellspacing="0" id="dataTableHCo" class="dataTableB1">
  ...
  <div id="tabs-2h" style="width:99.5%; height:90%;">
  <table width="100%" height="93%" border="1" cellpadding="4" cellspacing="0" id="dataTableHIm" class="dataTableB1">
    <thead id="cabecera_tBusquedaHco" class="miCabeceraDT">
      <tr>
  ...
  <div id="tabs-3h" style="width:99.5%; height:90%;">
  <table width="100%" height="93%" border="1" cellpadding="4" cellspacing="0" id="dataTableHLa" class="dataTableB1">
    <thead id="cabecera_tBusquedaHco" class="miCabeceraDT">
      <tr>
  ...
  <div id="tabs-4h" style="width:99.5%; height:90%;">
  <table width="100%" height="93%" border="1" cellpadding="4" cellspacing="0" id="dataTableHEn" class="dataTableB1">
    <thead id="cabecera_tBusquedaHco" class="miCabeceraDT">
      <tr>
  ...
  <div id="tabs-5h" style="width:99.5%; height:90%;">
  <table width="100%" height="93%" border="1" cellpadding="4" cellspacing="0" id="dataTableHSe" class="dataTableB1">
    <thead id="cabecera_tBusquedaHco" class="miCabeceraDT">
      <tr>
...
<div id="tabs-6" style="width:97.5%; height:90%; color:black; font-size:0.8em;">
 
<div id="tabs_sv" style="width:100%; height:99%;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:0.9em;">
  <tr>
    <td>
    <ul>
        <li><a id="tabs-1-1s" href="#tabs-1s" style="color:;">ÚLTIMOS</a></li>
        <li><a id="tabs-2-1s" href="#tabs-2s" style="color:;">RIESGOS</a></li>
        <li><a id="tabs-3-1s" href="#tabs-3s" style="color:;">RECOMENDACIONES</a></li>
        <li><a id="tabs-4-1s" href="#tabs-4s" style="color:;">HISTORIAL</a></li>
        <li><a id="tabs-5-1s" href="#tabs-5s" style="color:;">ESTADISTICAS</a></li>
    </ul>
    </td>
  ...
  <div id="tabs-1s" style="width:97.5%; height:90%; background-color:#DCDDDE;">
  <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tbody align="left">
      <tr>
        <td> 
      ...
      <tr>
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="2">
          <tr> 
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
              	<td align="left" class="titulosTabs" width="1px" nowrap>Peso</td>
                <td>
                <input name="pesoSV" type="text" id="pesoSV" onKeyUp="numeros_decimales(this.value, this.name);" maxlength="4" style="text-align:right;" class="required">
                </td>
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
              	<td align="left"class="titulosTabs"width="1px"nowrap>Cintura</td><td><input name="cinturaSV"type="text"id="cinturaSV"onKeyUp="numeros_decimales(this.value, this.name);"maxlength="4"style="text-align:right;" class="required"></td>
                <td align="left" class="titulosTabs">cm</td>
              </tr>
            </table>
            </td> 
          ...
          <tr> 
            ...
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
              	<td align="left"class="titulosTabs"width="1px"nowrap>Temp</td><td><input name="tempSV"type="text"id="tempSV"onKeyUp="numeros_decimales(this.value, this.name);"maxlength="4"style="text-align:right;" class="required"></td>
                <td align="left"class="titulosTabs" nowrap>ºC</td>
              </tr>
            </table>
            </td>
...
<div id="tabs-2s" style="width:97.5%; height:90%; font-size:0.9em; background-color:#DCDDDE;">
...
<div id="tabs-3s" style="width:97.5%; height:90%; font-size:1.1em; background-color:#DCDDDE;">
<table width="100%" border="0" cellspacing="0" cellpadding="3">
<tr>
	<td align="justify">
...
<tr id="recomendacionOB">
  ...
  <div id="tabs-4s" style="width:97.5%; height:90%; background-color:#DCDDDE;"> 
  <input name="id_medicoLab" id="id_medicoLab" type="hidden" value="">
  <input name="id_DepartamentoLab" id="id_DepartamentoLab" type="hidden" value="1">
  <table width="100%" height="100%" border="0" cellpadding="4" cellspacing="0" id="dataTableSV" class="tablilla" style="color:;">
...
<div id="tabs-5s" style="width:97.5%; height:90%; background-color:#DCDDDE;"> 
