...
<input name="idUsuario_hc" id="idUsuario_hc" type="hidden" value=""> <input name="idPaciente_hc" id="idPaciente_hc" type="hidden" value="">
  <div style="border:1px none red;">
      ...
      <tr>
        <td>
         <ul>
            <li><a id="tabs-1-1a" href="#tabs-1a" style="color:white; background-color:;">AHF</a></li>
            <li><a id="tabs-2-1a" href="#tabs-2a" style="color:white; background-color:;">APNP</a></li>
            <li><a id="tabs-3-1a" href="#tabs-3a" style="color:white; background-color:;">APP</a></li>
            <li><a id="tabs-4-1a" href="#tabs-4a" style="color:white; background-color:;">AGO</a></li>
          </ul>
        </td>
  ...
  <div id="tabs-1a" style="width:97.5%; height:90%;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="4" style="background-color:#DCDDDE; color:white;">
    <tr>
  ...
  <div id="tabs-2a" style="width:97.5%; height:90%;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="4" style="background-color:#DCDDDE; color:white;">
    <tr>
  ...
  <div id="tabs-3a" style="width:97.5%; height:90%;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="4" style="background-color:#DCDDDE; color:white;">
    <tr>
  ...
  <div id="tabs-4a" style="width:97.5%; height:90%;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="4" style="background-color:#DCDDDE; color:white;">
    <tr>
