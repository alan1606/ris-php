...
include_once '../../recursos/utilities.php';
 ...
 mysqli_select_db($horizonte, $database_horizonte);
 $sqlY = "insert into vacunas_aplicadas SET id_paciente_va = $idP, vacuna_va = $vacuna, aplicada_va = 1, enfermedad_va = $enfermedad, edad_va = $edad, dosis_va = $dosis, fecha_aplicacion_va = $fecha, id_usuario_va = $id_user, fecha_va = $now, esquema = 3";
