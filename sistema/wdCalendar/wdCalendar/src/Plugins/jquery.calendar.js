...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function quickd(type) {
            $("#bbit-cs-buddle").css("visibility", "hidden"); $("#bbit-cs-buddle").hide();
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
					//Cuando le damos click a un evento, se ejecuta esto alert(4);
					$('#bubbleClose2').css('top',10); $('#bbit-cs-buddle').show(); $('#bbit-cal-buddle').hide();
                    ...
                    if (bud.length == 0) {
                        ...
                        lbtn.click(function(e) {//aqui se controla cuando se va editar el nuevo evento segundo paso
                            if (!option.EditCmdhandler) {
                                alert("EditCmdhandler" + i18n.xgcalendar.i_undefined);
                            }
                            else { 
                                if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
                                    option.EditCmdhandler.call(this, $("#bbit-cs-buddle").data("cdata"));//this no importa
									//alert($("#bbit-cs-buddle").data("cdata"));
                                }
                            }
                            $("#bbit-cs-buddle").css("visibility", "hidden"); $('#bbit-cs-buddle').hide();
                            return false;
        ...
        function quickadd(start, end, isallday, pos) { 
            ...
            if (buddle.length == 0) {
                var temparr = [];
                temparr.push('<div id="bbit-cal-buddle" style="z-index: 180; width: 160px;visibility:hidden;" class="bubble">');
                ...
                temparr.push('<table style="display:none;" class="cb-table" cellSpacing="0" border="1" cellPadding="0"><tbody><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.time, ':</th><td class=cb-value><div style="display:;" id="bbit-cal-buddle-timeshow"></div></td></tr><tr><th class="cb-key">');
                temparr.push(i18n.xgcalendar.content, ':</th><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><input type="hidden" value="MI EVENTO" lang="koby" id="bbit-cal-what" class="textbox-fill-input"/></div></div><div class="cb-example">');
                ...
                temparr.push(i18n.xgcalendar.create_event, '" type="button"/>&nbsp; <SPAN style="display:none;" id="bbit-cal-editLink" class="lk">');
                ...
                var closebtn = $("#bubbleClose1").click(function() {
                    $("#bbit-cal-buddle").css("visibility", "hidden"); $('#bbit-cal-buddle').hide();
                    realsedragevent();
                });
                calbutton.click(function(e) { 
                    ...
                    if (option.extParam) {//lbtn.click(); //cuando se crea el evento 1er paso
					...
					//Aquí tengo que hacer una llamada y que me traiga el id del último evento y va en el primer parametro
					var datoUN ={userName:1}
					$.post('files-serverside/idUltimoE.php', datoUN, function(data1) {
						option.EditCmdhandler.call(this, [data1, $("#bbit-cal-what").val(), $("#bbit-cal-start").val(), $("#bbit-cal-end").val(), $("#bbit-cal-allday").val()]);
					});
			
					//$.post('files-serverside/idUltimoE.php',datoUN).done(function( data1 ) { });
                    ...
                    if (option.quickAddHandler && $.isFunction(option.quickAddHandler)) {
                        ...
                        $("#bbit-cal-buddle").css("visibility", "hidden").hide(); $('#bbit-cal-buddle').hide();
                        var newdata = [];
                        var tId = -1;
                ...
                lbtn.click(function(e) { //Cuando le editar evento en el primer paso
					var dateshow1 = CalDateShow(start, end, !isallday, true);
					//alert(dateshow1);
                    ...
                    if (!option.EditCmdhandler) {
                        ...
                        if (option.EditCmdhandler && $.isFunction(option.EditCmdhandler)) {
                            option.EditCmdhandler.call(this, ['41', $("#bbit-cal-what").val(), $("#bbit-cal-start").val(), $("#bbit-cal-end").val(), $("#bbit-cal-allday").val()]);
							alert($("#bbit-cal-what").val());
                        }
                        $("#bbit-cal-buddle").css("visibility", "hidden"); $('#bbit-cal-buddle').hide();
                        realsedragevent();
                    }
			...
			$('#bbit-cal-buddle').css('border','1px none red').css('padding-left',80).css('padding-top',140).show();
			$('.bubble-closebutton').css('top',150);
            var calwhat = $("#bbit-cal-what").val("MI EVENTO");
