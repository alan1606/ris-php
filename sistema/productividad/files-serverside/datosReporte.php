...
require("../../funciones/php/values.php");
 ...
 //total de pacinetes
 mysqli_select_db($horizonte, $database_horizonte);
 $result1z = mysqli_query($horizonte, "SELECT count(id_p) from pacientes ") or die (mysqli_error($horizonte));
 $row1z = mysqli_fetch_row($result1z);
 
 $avance = $row1z[0];
 
 //total de órdenes de venta
 mysqli_select_db($horizonte, $database_horizonte);
 $result2 = mysqli_query($horizonte, "SELECT count(id_ov) from orden_venta where 1 = 1 ") or die (mysqli_error($horizonte));
 ...
 if($row1[0]!=0){
 $PPU = ($row9[0]*100)/$row1[0];}else{$PPU = 0;}$PPU =111;
 //Porcentaje total fuera de Rango
 if($row1[0]!=0){
 $PTFR = ($row5[0]*100)/$row1[0];}else{$PTFR = 0;}$PTFR =111;
 ...
 echo $row[0].";".$row1[0].";".$avance.";".$row2[0].";".$row3[0].";".$row4[0].";".$row4a[0].";".$row4b[0].";".$row4c[0].";".$row5.";".$row6.";".$row7.";".$row7a.";".$row7b.";".$row7c.";".$row7d.";".$row8[0].";".$PTDi.";".$PTH1.";".$PTD1.";".$PTDi1.";".$row9[0].";".$PPU;
