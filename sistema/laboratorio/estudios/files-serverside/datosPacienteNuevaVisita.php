...
require("../../funciones/php/values.php");
 ...
 $indiceP = sqlValue($_POST["indiceP"], "text", $horizonte);

 	mysqli_select_db($horizonte, $database_horizonte);
 	$result = mysqli_query($horizonte, "SELECT nombre_p, apaterno_p, amaterno_p, fNac_p, sexo_p, id_p from pacientes where indice_p = $indiceP ") or die (mysqli_error($horizonte));
	...
	echo $nombre.";".$edad.";".$sexo.";".$row[5].";".$indiceP;
