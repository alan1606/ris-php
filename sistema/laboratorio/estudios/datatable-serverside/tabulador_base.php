...
require("../../../Connections/horizonte.php");
		...
		$aColumns = array('c.id_to', 'c.concepto_to', 'a.nombre_a', 'c.precio_to','c.precio_urgencia_to', 'c.precio1_to','c.precio_urgencia1_to', 'c.dias_entrega_to', 'c.id_to', 'c.aleatorio_c');
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		if($_GET['access']==1){
			$row[1]="<span id='$row[8]' lang='$row[9]' onClick='verPaciente(this.id,this.lang);' class='celdas_accion'>$row[1]</span>";
		}
		else{ $row[1]="<span id='$row[8]' lang='$row[9]'>$row[1]</span>"; }
