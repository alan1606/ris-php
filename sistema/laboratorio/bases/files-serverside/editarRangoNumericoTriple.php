...
require("../../../funciones/php/values.php");
 ...
 $sql = "UPDATE asignar_valor_referencia SET valor_normal_nma = $valorN, valor_r1_moderado = $rangoI, valor_r2_moderado = $rangoF, valor_alto_nma = $valorA, para_sexo = $sexo, para_edades = $tipoEdad, rango_edad1 = $edadI, rango_edad2 = $edadF, tipo_edad = $tipo_edadR where id_avr = $id limit 1";
