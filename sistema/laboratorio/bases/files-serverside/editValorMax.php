...
require("../../../funciones/php/values.php");
 ...
 $valor = sqlValue($_POST["valorMax"], "int", $horizonte);
 ...
 $sql = "UPDATE asignar_valor_referencia SET valor_maximo = $valor, para_sexo = $sexo, para_edades = $tipoEdad, rango_edad1 = $edadI, rango_edad2 = $edadF, tipo_edad = $tipo_edadR where id_avr = $id limit 1";
