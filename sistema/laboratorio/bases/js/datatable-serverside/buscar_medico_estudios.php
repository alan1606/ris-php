...
require("../../../Connections/sigma.php");
    ...
    */
	...
	$aColumns = array('clave_u' , 'u.nombre_u', 'u.apaterno_u','u.amaterno_u', 'e.nombre_especialidad', 'u.id_u' );
    ...
    $sIndexColumn = "u.id_u";
	 ...
	 // Joins   
	$sJoin = 'left join especialidades e on e.id_es = u.idEspecialidad_u';//, sucursales s';
...
//and id = id_umedica GROUP BY id ";
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$row[5] = "<img src='../imagenes/pagina_visitas/seleccionado1.png' width='30' class='opacidad_0' height=''>";
