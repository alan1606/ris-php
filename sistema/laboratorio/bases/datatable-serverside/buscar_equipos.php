...
require("../../../Connections/horizonte.php");
	$aColumns = array('e.modelo_eq', 'e.marca_eq','e.id_eq');
     
    // DB tables to use 
    $aTables = array( 'catalogo_equipos e');
     
    // Indexed column (used for fast and accurate table cardinality) 
    $sIndexColumn = "e.id_eq";
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$nombreB='"'.$row[0].'"';
		$row[0] = "<span lang='$row[2]' style='cursor:pointer;' onClick='fichaEQ($row[2], $nombreB);'>$row[0]</span>";
