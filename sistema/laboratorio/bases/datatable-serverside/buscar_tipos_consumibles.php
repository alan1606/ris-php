...
require("../../../Connections/horizonte.php");
	$aColumns = array('t.tipo_cti','t.id_cti');
     
    // DB tables to use 
    $aTables = array( 'catalogo_tipo_inventario t');
     
    // Indexed column (used for fast and accurate table cardinality) 
    $sIndexColumn = "t.id_cti";
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$nombreB='"'.$row[0].'"';
		$row[0] = "<span lang='$row[1]' style='cursor:pointer;' onClick='fichaTCon($row[1], $nombreB);'>$row[0]</span>";
