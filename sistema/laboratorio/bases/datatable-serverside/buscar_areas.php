...
require("../../../Connections/horizonte.php");
	$aColumns = array('a.nombre_a', 'a.clave_a', 'a.id_a');
     
    // DB tables to use 
    $aTables = array( 'areas a');
    ...
    // CONDITIONS 
    $sWhere = "WHERE a.nombre_a != 'CONTABILIDAD' and departamento_a = 1 " ;
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$nombreB='"'.$row[0].'"';
		$row[0] = "<span lang='$row[2]' style='cursor:pointer;' onClick='fichaAr($row[2], $nombreB);'>$row[0]</span>";
