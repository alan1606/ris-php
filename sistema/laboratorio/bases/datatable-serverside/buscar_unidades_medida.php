...
require("../../../Connections/horizonte.php");
	$aColumns = array('u.unidad_un', 'u.abreviacion_un','u.id_un');
     
    // DB tables to use 
    $aTables = array( 'unidades u');
     
    // Indexed column (used for fast and accurate table cardinality) 
    $sIndexColumn = "u.id_un";
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$nombreB='"'.$row[0].'"';
		$row[0] = "<span lang='$row[2]' style='cursor:pointer;' onClick='fichaUM($row[2], $nombreB);'>$row[0]</span>";
