...
while ($fila = mysqli_fetch_array($query)) {//$fila['convenio_cv'];
	...
	if($fila['id_cvr']==1){
		...
		<tr> 
		<td>'.$fila['base_b'].'</td>
		<td align="left">'.$fila['tipo_cvr'].'</td>
		<td align="center">
			<input name="'.$fila['id_rl'].'" id="'.$fila['id_rl'].'" lang ="'.$fila['id_cvr'].'" type="text" class="form-control required input-sm" style="text-align:center;"onKeyUp="conMayusculas(this);" required>
		</td>
	...
	if($fila['id_cvr']==3){
		...
		<td align="left">'.$fila['tipo_cvr'].'</td>
		<td align="center">
			<input name="'.$fila['id_rl'].'" id="'.$fila['id_rl'].'" lang ="'.$fila['id_cvr'].'" type="text" class="form-control input-sm required" style="text-align:center;" required>
		</td>
		<td align="center">
	...
	if($fila['id_cvr']==6){
		...
		<td align="left">'.$fila['tipo_cvr'].'</td>
		<td align="center">
			<input name="'.$fila['id_rl'].'" id="'.$fila['id_rl'].'" lang ="'.$fila['id_cvr'].'" type="text" class="form-control required input-sm" style="text-align:center;" required>
		</td>
