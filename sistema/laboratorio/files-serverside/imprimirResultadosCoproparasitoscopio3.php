...
$tabla = '<table id="p_contenido" width="100" border="0" cellspacing="2" cellpadding="4" style="text-align:left; font-size:12px;"> <tr style="font-weight:bold;">
		<td width="200">EXAMEN FISICO</td> <td width="100" align="right" nowrap>1RA MUESTRA</td> <td width="100" align="right" nowrap>2DA MUESTRA</td> <td width="100" align="right" nowrap>3ER MUESTRA</td> <td align="center">VALORES DE REFERENCIA</td> <td align="right" style=" display:none;">UNIDADES</td> </tr>';
...
while ($fila = mysqli_fetch_array($query)) { $i++;
	...
	if($fila['id_cvr']==1){
		...
		<td>EXAMEN QUÍMICO</td> <td width="1%" align="right" nowrap>1RA MUESTRA</td> <td width="1%" align="right" nowrap>2DA MUESTRA</td> <td width="1%" align="right" nowrap>3ER MUESTRA</td> <td align="center" nowrap>VALORES REFERENCIA</td> <td align="center"style="display:none;">UNIDADES</td> </tr>';
		}
	...
	if($fila['id_cvr']==2){
		...
		if($i==18){
			$tabla = $tabla.'<tr style="font-weight:bold;">
		<td>EXAMEN MICROSCÓPICO</td> <td width="1%" align="right" nowrap>1RA MUESTRA</td> <td width="1%" align="right" nowrap>2DA MUESTRA</td> <td width="1%" align="right" nowrap>3ER MUESTRA</td> <td align="center" nowrap>VALORES REFERENCIA</td> <td align="center" style="display:none;">UNIDADES</td> </tr>';
		}
	}
...
if($f>0){//					  height="380"
	$tabla = $tabla.'<tr> <td height="300" valign="top" nowrap colspan="6" style="font-size:0.2em; font-style:italic;" id="notaF"><hr style=" height:1px;"><em>NOTA: <strong>*</strong> SIGNIFICA VALOR FUERA DE RANGO</em> </td> </tr>';
