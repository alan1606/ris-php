...
$idEvc = sqlValue($_GET["idE"], "int", $horizonte); $i = 0; $f = 0; $idU = sqlValue($_GET["idU"], "int", $horizonte);
  														//cellspacing="23"
$tabla = '<table id="p_contenido" width="100" border="0" cellspacing="13" cellpadding="4" style="text-align:left;"> <tr style="font-weight:bold;">
		<td width="230">EXAMEN FISICO</td> <td width="140" align="right">RESULTADO</td> <td width="1"></td> <td width="200" align="center">VALORES DE REFERENCIA</td> <td align="right" style=" display:none;">UNIDADES</td> </tr>';
...
while ($fila = mysqli_fetch_array($query)) { $i++;
	...
	if($fila['id_cvr']==1){
		...
		<td>EXAMEN QUÍMICO</td> <td width="1%" align="right">RESULTADO</td> <td width="1"></td> <td align="center" nowrap>VALORES DE REFERENCIA</td> <td align="center" style="display:none;">UNIDADES</td> </tr>';
		}
	...
	if($fila['id_cvr']==2){
		...
		if($i==9){
			$tabla = $tabla.'<tr style="font-weight:bold;">
		<td>EXAMEN MICROSCÓPICO</td> <td width="1%" align="right">RESULTADO</td> <td width="1"></td> <td align="center" nowrap>VALORES DE REFERENCIA</td> <td align="center" style="display:none;">UNIDADES</td> </tr>';
		}
	}
