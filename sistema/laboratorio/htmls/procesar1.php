...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#DCDDDE">
  ...
  <tr>
    <td>
    <table width="100%" border="0" cellspacing="0" cellpadding="1"> 
    	<tr> <td class="titulosTabs" align="left" width="115px" nowrap>Notas de recepción</td> <td><textarea class="campoITtab" name="observacionPro" id="observacionPro" cols="1" rows="2" readonly style="resize:none; height:100%"></textarea></td> </tr> 
    </table>
    </td>
  </tr>
  <tr>
    <td>
    <table width="100%" border="0" cellspacing="0" cellpadding="1"> 
    	<tr> <td class="titulosTabs" align="left" width="115px" nowrap><em><strong>Nota para el médico</strong></em></td> <td><textarea class="campoITtab" name="notaPro" id="notaPro" cols="1" rows="2" style="resize:none; height:100%; color:red;" onKeyUp="conMayusculas(this);"></textarea></td> </tr> 
    </table>
    </td>
  </tr>
  <tr class="variosEstu">
