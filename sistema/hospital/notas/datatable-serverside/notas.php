...
require("../../../Connections/horizonte.php"); 
	...
	$aColumns = array('n.id_nm', 'n.nombre_nm', 'a.nombre_a', 'n.id_nm');
    ...
    $sIndexColumn = "n.id_nm";
	 ...
	 // Joins hasta aqui
	$sJoin = 'left join areas a on a.id_a = n.id_area_nm ';
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$row[1] = "<span id='$row[3]' onClick='verPaciente(this.id);' class='celdas_accion'>$row[1]</span>";
