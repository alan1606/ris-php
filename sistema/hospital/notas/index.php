...
<meta charset="utf-8">
<title>CATÁLOGO DE NOTAS MÉDICAS</title>
...
$("#dialog-confirmarNuevoPaciente").load("htmls/ficha_estudio.php",function(response, status, xhr) { if(status=="success"){
	...
	$('#dialog-confirmarNuevoPaciente').dialog({
		title:'NUEVA NOTA MÉDICA',modal:true,autoOpen:true,closeText:'',width:wi,height:he,closeOnEscape:false,
...
<div id="header" class="header">
    <table height="100%" width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td align="left" valign="middle"><span id="verMenu" style="cursor:pointer;">CATÁLOGO DE NOTAS MÉDICAS</span></td>
  ...
  <table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0" id="dataTablePrincipal" class="tablilla">
    <thead id="cabecera_tBusquedaPrincipal">
      <tr class="titulos_dataceldas">
        ...
        <th align="center">
        NOTA
        <button id='addPacientePrincipal' onClick='nuevoPaciente()' class='ui-button ui-widget ui-corner-all ui-button-icon-only' title='Agregar una nueva nota médica'><span class='ui-icon ui-icon-plus'>s</span></button>
        </th>
