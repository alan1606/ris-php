...
while ($fila = mysqli_fetch_array($query)) {//$fila['convenio_cv'];
	...
	if($fila['id_cvr']==8){
		...
		<td align="center">'.$fila['tipo_cvr'].'</td>
		<td align="center">
			<input name="'.$fila['id_rl'].'" id="'.$fila['id_rl'].'" lang ="'.$fila['id_cvr'].'" type="text" class="campoITtab required"  style="text-align:center;" value="'.$fila['r_valor_nma_rl'].'">
		</td>
		<td align="center">
	...
	if($fila['id_cvr']==9){
		...
		<td align="center">'.$fila['tipo_cvr'].'</td>
		<td align="center">
			<input name="'.$fila['id_rl'].'" id="'.$fila['id_rl'].'" lang ="'.$fila['id_cvr'].'" type="text" class="campoITtab required"  style="text-align:center;" value="'.$fila['r_valor_nma_i_rl'].'">
		</td>
		<td align="center">
			<table width="" border="0" cellspacing="0" cellpadding="2" style="text-align:; float:;">
			  <tr>
