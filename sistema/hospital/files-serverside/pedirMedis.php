...
require("../../funciones/php/values.php");
	...
	$result = mysqli_query($horizonte, "SELECT id_medicamento_mh, indicacion_mh, id_mh from medicamentos_hospital where id_hospitalizacion_mh = $idH and aleatorio_mh = $aleatorio") or die (mysqli_error($horizonte)); 
