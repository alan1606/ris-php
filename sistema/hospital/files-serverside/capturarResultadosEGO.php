	...
	if($fila['id_cvr']==1){
		...
		<td align="center">';
			if($name1[0]=='ASPECTO'){
				...
				$tabla = $tabla.'<input name="'.$fila['id_rl'].'" id="'.$fila['id_rl'].'" lang ="'.$fila['id_cvr'].'" type="text" class="campoITtab required" style="text-align:center;"onKeyUp="conMayusculas(this);" value="NEGATIVO">';
			}
