...
$tabla = '<table width="100%" border="0" cellspacing="1" cellpadding="2"> <tr style="font-weight:bold;">
		<td>EXAMEN FÍSICO</td> <td width="" align="right">RESULTADO</td> <td align="center" nowrap>VALORES DE REFERENCIA</td> <td align="right" style="display:;">UNIDADES</td> </tr>';
...
while ($fila = mysqli_fetch_array($query)) { $i++;
	...
	if($fila['id_cvr']==1){
		...
		<td align="right" nowrap> '.$asterix.' '.$fila['r_valor_texto'].' </td>
		';
		...
		<td>EXAMEN QUÍMICO</td> <td width="" align="right">RESULTADO</td> <td align="center" nowrap>VALORES DE REFERENCIA</td> <td align="right" style="display:;">UNIDADES</td> </tr>';
		}
...
if($f>0){
	$tabla = $tabla.'<tr> <td nowrap colspan="4" style="font-size:0.2em; font-style:italic;" id="notaF">NOTA: <strong>*</strong> SIGNIFICA VALOR FUERA DE RANGO </td> </tr>';
}
