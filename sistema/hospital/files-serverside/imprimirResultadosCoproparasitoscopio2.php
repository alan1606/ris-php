...
$tabla = '<table width="100%" border="0" cellspacing="1" cellpadding="2"> <tr style="font-weight:bold;">
		<td>EXAMEN FISICO</td> <td width="1%" align="center" nowrap>1RA MUESTRA</td> <td width="1%" align="center" nowrap>2DA MUESTRA</td> <td align="center">VALORES DE REFERENCIA</td> <td align="right" style=" display:none;">UNIDADES</td> </tr>';
...
while ($fila = mysqli_fetch_array($query)) { $i++;
	...
	if($fila['id_cvr']==1){
		...
		<td>EXAMEN QUÍMICO</td> <td width="1%" align="center" nowrap>1RA MUESTRA</td> <td width="1%" align="center" nowrap>2DA MUESTRA</td> <td align="center" nowrap>VALORES REFERENCIA</td> <td align="center"style="display:none;">UNIDADES</td> </tr>';
		}
	...
	if($fila['id_cvr']==2){
		...
		if($i==18){
			$tabla = $tabla.'<tr style="font-weight:bold;">
		<td>EXAMEN MICROSCÓPICO</td> <td width="1%" align="center" nowrap>1RA MUESTRA</td> <td width="1%" align="center" nowrap>2DA MUESTRA</td> <td align="center" nowrap>VALORES REFERENCIA</td> <td align="center" style="display:none;">UNIDADES</td> </tr>';
		}
	}
