<div id="miNotaE" class="fondo_tab">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr height="1%">
    <td align="left" height="1px">
    <table width="100%" border="0" cellspacing="0" cellpadding="4" style="border-bottom:1px dashed white;">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td valign="top" align="justify" style="border-left:1px dashed black; padding-left:3px;border-bottom:1px dashed white;">
        	<span id="notaNE"></span>
        </td>
      </tr>
    </table>
