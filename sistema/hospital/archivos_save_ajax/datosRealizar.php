...
mysqli_select_db($horizonte, $database_horizonte);
$result6 = mysqli_query($horizonte, "SELECT count(id_vc) from venta_conceptos where estatus_vc = 2 and referencia_vc = $ref and area_vc = 55") or die (mysqli_error($horizonte));
