...
mysqli_select_db($horizonte, $database_horizonte);
$result6 = mysqli_query($horizonte, "SELECT count(id_vc) from venta_conceptos where estatus_vc = 4 and referencia_vc = $ref and tipo_concepto_vc = 3") or die (mysqli_error($horizonte));
