...
require("../../../Connections/horizonte.php");
    ...
    */
	...
	$aColumns = array('clave_est' , 'e.nombre_est', 'a.nombre_a','e.precio_est','e.id_est' );
     
    // DB tables to use 
    $aTables = array( 'estudios e');
     
    // Indexed column (used for fast and accurate table cardinality) 
    $sIndexColumn = "e.id_est";
     
	 // Joins   
	$sJoin = 'left JOIN areas a ON a.id_a = e.area_est';//, sucursales s';
	   
	 
    // CONDITIONS 
    $sWhere = "WHERE e.depto_est = 2 " ;
...
//and id = id_umedica GROUP BY id ";
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$row[4] = "<img src='../imagenes/pagina_visitas/seleccionado.png' width='25' class='opacidad_0' height='20'>";
