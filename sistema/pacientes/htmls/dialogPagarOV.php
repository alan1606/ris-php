<div id="pagarOV" style="border:1px none red; height:385px; font-size:0.9em;">
<form action="" method="post" name="form-pagar" id="form-pagar" target="_self" style="height:100%">
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td align="right" class="">forma de pago</td>
  ...
  <tr>
    <td align="right" class="">paga con $</td>
  ...
  <tr>
    <td align="right" class="" style="color:; font-size:;">cambio $</td>
