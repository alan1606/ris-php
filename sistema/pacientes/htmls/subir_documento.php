...
<table width="100%" height="100%" border="0" cellspacing="4" cellpadding="6">
  ...
  <tr>
    ...
    <td align="left">
    	<input name="titulo_d" type="text" class="required" id="titulo_d" style="width:99%;" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);" maxlength="50" autofocus>
    </td>
  </tr>
  <tr>
    ...
    <span class="btn btn-success fileinput-button">
        ...
        <input id="fileupload" type="file" name="files[]" class="" style="color:transparent;"accept="image/jpg, image/jpeg, image/png, application/pdf">
    </span>
    <br>
