<div id="buscarMedicoX" style="margin-top:-10px;">
<table width="99%" cellspacing="0" id="dataTableBMConsulta" height="100%" border="0" cellpadding="4" class="tablilla" style=" font-size:12px;">
    ...
    <tfoot class="pieTablaBMCo" id="mi_pie_tabla" align="center">
        <tr bgcolor="#FF6633" height="20px">
            <th><input type="text" name="textfield1" id="textfield1" style="height:22px; width:100%;" class="search_init" placeholder="-Nombre-"></th>
            <th><input type="text" name="textfield2" id="textfield2" style="height:22px; width:100%;" class="search_init" placeholder="-Apaterno-"></th>
            <th><input type="text" name="textfield3" id="textfield3" style="height:22px; width:100%;" class="search_init" placeholder="-Amaterno-"></th>
            <th><input type="text" name="textfield4" id="textfield4" style="height:22px; width:100%;" class="search_init" placeholder="-Cargo-"></th>
        </tr>
    </tfoot>
  </table>
<div id="errorSeleccionMédico" style="display:none;"><span class="alerta_no_seleccion">Debe de seleccionar algún personal médico, dé clic sobre uno de ellos.</span></div>
