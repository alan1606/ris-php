...
//datos generales
 ...
 $idSucursal = sqlValue($_POST["sucursalP"], "int", $horizonte); // idSucursal_p = $idSucursal
 $centroSaludP = sqlValue($_POST["centroSaludP"], "int", $horizonte);
 $derechohabiencia = sqlValue($_POST["derechohabienciaP"], "int", $horizonte);
 ...
 $nombre_completo = $_POST["nombreP"].' '.$_POST["apaternoP"].' '.$_POST["amaternoP"];
 $nombre_completo = sqlValue($nombre_completo, "text", $horizonte);
 ...
 $foto = sqlValue($_POST["fotoU"], "int", $horizonte);
 $no_temp = sqlValue($_POST["temporal_s"], "text", $horizonte);
