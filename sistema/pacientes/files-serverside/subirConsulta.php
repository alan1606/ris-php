...
//Checamos si existe otra consulta con este número aleatorio:
 ...
 if($rowC[0]>0){
 	...
 	$sql.= "VALUES ($noTemp, $idP, $idU, $idMedico, $precioCo, $idConvenio, $total, 4, $idArea, $idC, $idSucursal, $motivo, $fechaC, 1, $idU, $now, $id_con_bene)";
 }
