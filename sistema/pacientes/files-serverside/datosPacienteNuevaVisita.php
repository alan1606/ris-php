...
require("../../funciones/php/values.php");
 ...
 if(isset($_POST["idU"])){$idU=sqlValue($_POST["idU"], "int", $horizonte);
	...
	$idSucursal = $rowS[0];
 	...
 	mysqli_select_db($horizonte, $database_horizonte);
 	$result = mysqli_query($horizonte, "SELECT nombre_p, apaterno_p, amaterno_p, fNac_p, sexo_p, id_p, indice_p, idSucursal_p, foto_p, id_p, temporal_p from pacientes where id_p = $idP ") or die (mysqli_error($horizonte));
 	$row = mysqli_fetch_row($result); $temp_u = sqlValue($row[10], "text", $horizonte);
	...
	echo $nombre.";".$edad.";".$sexo.";".$row[5].";".$row[6].";".$row[7].";".$idSucursal.";".$row[8].";".$row[9].";".$rowEx1[0].";".$row[10];
