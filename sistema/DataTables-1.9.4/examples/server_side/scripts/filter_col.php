<?php
  /* MySQL connection */
	...
	if ( $_GET['sSearch'] != "" )
	{
		$sWhere = "WHERE ( engine LIKE '%".mysqli_real_escape_string( $gaSql['link'], $_GET['sSearch'] )."%' OR ".
		                "browser LIKE '%".mysqli_real_escape_string( $gaSql['link'], $_GET['sSearch'] )."%' OR ".
		                "platform LIKE '%".mysqli_real_escape_string( $gaSql['link'], $_GET['sSearch'] )."%' OR ".
		                "version LIKE '%".mysqli_real_escape_string( $gaSql['link'], $_GET['sSearch'] )."%' OR ".
		                "grade LIKE '%".mysqli_real_escape_string( $gaSql['link'], $_GET['sSearch'] )."%' )";
	}
