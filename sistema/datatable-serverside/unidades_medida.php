...
require("../funciones/php/values.php");
	...
	$aColumns = array('u.id_un', 'u.unidad_un', 'u.abreviacion_un', 'concat(us.nombre_u," ",us.apaterno_u, " ", amaterno_u)', 'DATE_FORMAT(u.fecha_un,"%d/%m/%Y %H:%i")', 'u.id_un');
    ...
    $sIndexColumn = "u.id_un";
	 ...
	 // Joins   
	$sJoin = 'left join usuarios us on us.id_u = u.usuario_un';
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$row[1] = "<button type='button' class='btn btn-xs btn-link' onClick='editar($row[5], $nombreU)'>$row[1]</button>";
