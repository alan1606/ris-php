...
//Generales
 ...
 $resultR = mysqli_query($horizonte, "SELECT area_vc from venta_conceptos where referencia_vc = $ref and tipo_concepto_vc = 3 ", $sigma) or die (mysqli_error($horizonte));
