...
require("../../../Connections/horizonte.php"); 
	...
	$aColumns = array('c.id_to', 'c.concepto_to', 'c.precio_to','c.precio_urgencia_to', 'c.precio_m','c.precio_mu', 'c.id_to');
    ...
    // CONDITIONS
    $sWhere = "where c.id_tipo_concepto_to = 2 and c.id_to not in (select id_to from conceptos where descripcion_to = 'membresia_h') ";
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		if($_GET['accesoU']==1){
			$row[1]= "<span class='text-info' style='cursor:pointer; text-decoration:underline;' id='$row[6]' lang='$row[1]' onClick='fichaEstudio(this.id, this.lang);'>$row[1]</span>";
		}
