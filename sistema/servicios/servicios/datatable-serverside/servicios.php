...
require("../../../Connections/horizonte.php"); 
	...
	if(isset($_GET['idSu'])){
		...
		$aColumns = array('c.id_to', 'c.concepto_to', $precio_nor,$precio_ur, 'c.id_to');
	}else{
		$aColumns = array('c.id_to', 'c.concepto_to', 'c.precio_to','c.precio_urgencia_to', 'c.id_to');
	}
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		$row[1] = "<span id='$row[4]' onClick='verPaciente(this.id);' class='celdas_accion' >$row[1]</span>";
