...
require("../../../funciones/php/values.php");
 ...
 $sql = "UPDATE conceptos set concepto_to = $nombre, precio_to = $precio, precio_urgencia_to = $precioU, formato = $formato, precio_m = $precioM, precio_mu = $precioMU where id_to = $idEstudio";
