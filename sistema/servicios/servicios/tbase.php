...
<meta charset="utf-8">
<title>TABULADOR BASE DE SERVICIOS MÉDICOS</title>
...
$("#dialog-confirmarNuevoPaciente").load("htmls/ficha_tabs_base.php",function(response,status,xhr){
	if(status=="success"){	
		...
		$('#dialog-confirmarNuevoPaciente').dialog({
			...
			"GUARDAR": function() {
				if($('#formServicio').valid()){ 
					...
					$.post('files-serverside/addTabs_base.php',datosP).done(function( data ) {
						if (data==1){
							$('#clickme').click();
...
$("#dialog-confirmarNuevoPaciente").load("htmls/ficha_tabs_base.php",function(response,status,xhr){ if(status=="success"){
		var datos ={idS:x}
		$.post('files-serverside/fichaTabuladores_base.php',datos).done(function(data1) { 
			...
			$('#dialog-confirmarNuevoPaciente').dialog({
				...
				"ACTUALIZAR": function() {
					if($('#formServicio').valid()){
						...
						$.post('files-serverside/updateTabs_base.php',datosS).done(function( data ) {
...
<div id="header" class="header">
    <table height="100%" width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="120" align="right" class="iconito"><img src="../../imagenes/iconitos/_subgastos_icon.png" height="40"></td>
        <td align="left" valign="middle"><span id="verMenu" style="cursor:pointer;">TABULADOR BASE SERVICIOS</span></td>
  ...
  <table width="90%" height="100%" border="0" cellpadding="5" cellspacing="0" id="dataTablePrincipal" class="tablilla">
    <thead id="cabecera_tBusquedaPrincipal">
      <tr class="titulos_dataceldas">
        ...
        <th align="center" nowrap>TABULADOR BASE</th>
     	<th align="center" nowrap>TABULADOR BASE URGENCIA</th>
      </tr>
    </thead>
...
$(document).ready(function() {
	...
	oTableP = $('#dataTablePrincipal').dataTable({
		...
		"sAjaxSource": "datatable-serverside/servicios_base.php",
