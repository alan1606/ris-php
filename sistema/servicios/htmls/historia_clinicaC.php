...
<input name="idUsuario_hc" id="idUsuario_hc" type="hidden" value=""> <input name="idPaciente_hc" id="idPaciente_hc" type="hidden" value="">
  <div style="border:1px none red;">
      ...
      <tr>
        <td>
         <ul>
            <li><a id="tabs-1-1a" href="#tabs-1a" style="color:; background-color:;">AHF</a></li>
            <li><a id="tabs-2-1a" href="#tabs-2a" style="color:; background-color:;">APNP</a></li>
            <li><a id="tabs-3-1a" href="#tabs-3a" style="color:; background-color:;">APP</a></li>
            <li><a id="tabs-4-1a" href="#tabs-4a" style="color:; background-color:;">AGO</a></li>
          </ul>
        </td>
        <td align="right" style="padding-right:13px;">
        <button class="botonC editar"name="b_editarHC"id="b_editarHC">Editar</button> 
        <button class="botonC actualizar"name="b_actualizarHC" id="b_actualizarHC">Actualizar</button> 
        <button class="botonC cancelar" name="b_cancelHC" id="b_cancelHC">Cancelar</button>
        </td>
      </tr>
    </table>
  </div>
  
  <div id="tabs-1a" style="width:99%; height:93%;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="4" style="background-color:#DCDDDE; color:black;">
    <tr>
    ...
    <tr>
      ...
      <td colspan="5"> 
      	<input class="textHC" name="ahf_notas" type="text" id="ahf_notas" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);" style="color:black"> 
      </td>
    </tr>
  </table>
  </div>
  
  <div id="tabs-2a" style="width:99%; height:93%;">
  <table width="100%" height="100%" border="0" cellpadding="4" cellspacing="0" style="background-color:#DCDDDE; color:black;">
    <tr>
    ...
    <tr>
      ...
      <td align="right"><h2>Recreación</h2></td>
    ...
    <tr>
      <td align="left"><h2>Notas</h2></td>
      <td colspan="6"> <input class="textHC" name="apnp_notas" type="text" id="apnp_notas" value="" size="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);"> </td>
    </tr>
    <tr>
      ...
      <td> 
      	<select name="habitantes" id="habitantes" class="selectHC"> <option value="">-NÚMERO-</option> <option value="0">0</option> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option>
        <option value="6">6</option> <option value="7">7</option> <option value="8">8</option> <option value="9">9</option> <option value="10">10+</option> </select> 
      </td>
  ...
  <div id="tabs-3a" style="width:99%; height:93%;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="4" style="background-color:#DCDDDE; color:black;">
    <tr>
    ...
    <tr>
      <td width="80px" align="left" valign="middle"><h2>Alérgias</h2></td>
      <td colspan="5">
      	 <table width="100%" border="0" cellspacing="0" cellpadding="4">
          <tr>
            <td>
            <input name="alergia1" type="text" id="alergia1" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);">
            </td>
            <td>
            <input name="alergia2" type="text" id="alergia2" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);">
            </td>
            <td>
            <input name="alergia3" type="text" id="alergia3" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);">
            </td>
          </tr>
          <tr>
            <td>
            <input name="alergia4" type="text" id="alergia4" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);">
            </td>
            <td>
            <input name="alergia5" type="text" id="alergia5" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);">
            </td>
            <td>
            <input name="alergia6" type="text" id="alergia6" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);">
            </td>
          </tr>
        </table>
      </td>
  ...
  <div id="tabs-4a" style="width:99%; height:93%;">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="4" style="background-color:#DCDDDE; color:black;">
    <tr>
    ...
    <tr>
      <td align="left"><h2 title="Fecha de última regla">F.U.R.</h2></td>
      <td> <input name="fur" type="text" id="fur" value="" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);"></td>
      <td align="right"><h2 title="Iniciación de vida sexual activa">I.V.S.A.</h2></td>
      <td> 
