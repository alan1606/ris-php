...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="2" style="font-size:0.8em;" bgcolor="#BBB">
  <tr height="50%">
    ...
    <table width="99%" cellspacing="0" id="dataTableBDX" height="100%" border="0" cellpadding="5" class="tablilla" bgcolor="#FFFFFF">
        <thead id="my_head">
          <tr>
            <th class="titulosTabs" align="center" width="1%;" style="color:;">CLAVE</th>
            <th class="titulosTabs" align="center" style="color:;">
            	DIAGNÓSTICO &nbsp;
  ...
  <tr>
    ...
    <table width="99%" cellspacing="0" id="dataTableDXS" height="100%" border="0" cellpadding="5" class="tablilla" bgcolor="#FFFFFF">
        <thead id="my_head">
          <tr>
          	<th id="clickmeDXS" class="titulosTabs" align="center" width="1%" style="color:;">#</th>
            <th class="titulosTabs" align="center" width="1%" style="color:;">CLAVE</th>
            <th class="titulosTabs" align="center" style="color:;">DIAGNÓSTICO</th>
            <th class="titulosTabs" align="center" width="1%" style="color:;">ELIMINAR</th>
          </tr>
        </thead>
        <tbody align="left"> <tr> <td class="dataTables_empty">Cargando datos del servidor</td> </tr> </tbody>
      </table>
...
<table width="99%" height="100%" border="0" cellspacing="0" cellpadding="2" style="font-size:0.8em;" bgcolor="#AAA">
  <tr height="50%">
    ...
    <table width="100%" cellspacing="0" id="dataTableBMedicamentos" height="100%" border="0" cellpadding="4" class="tablilla" bgcolor="#FFFFFF">
        <thead id="my_head">
          <tr>
            <th class="titulosTabs azulito" align="center" width="1%" style="color:;">CLAVE</th>
            <th class="titulosTabs" align="center" style="color:;">
            	MEDICAMENTO&nbsp;
                <button id="altaMedicamento">¡Si el medicamento no existe en la base de datos, puede dar uno de alta aquí!</button>
            </th>
            <th class="titulosTabs" align="center" style="color:;">PRESENTACIÓN</th>
            <th class="titulosTabs" align="center" style="color:;">CONCENTRACIÓN</th>
          </tr>
        </thead>
        <tbody align="left"> <tr> <td class="dataTables_empty">Cargando datos del servidor</td> </tr> </tbody>
  ...
  <tr>
    ...
    <table width="100%" cellspacing="0" id="dataTableMS" height="100%" border="0" cellpadding="4" class="tablilla" bgcolor="#FFFFFF">
        <thead id="my_head">
          <tr>
          	<th id="clickmeMS" class="titulosTabs" align="center" width="1%" style="color:;">#</th>
            <th class="titulosTabs" align="center" style="color:;">MEDICAMENTO</th>
            <th class="titulosTabs" align="center" style="color:;">PRESENTACIÓN</th>
            <th class="titulosTabs" align="center" style="color:;">CONCENTRACIÓN</th>
            <th class="titulosTabs" align="center" width="1%" style="color:;">ELIMINAR</th>
          </tr>
