  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
      <tr>
        ...
        <td align="left"><input name="clave_ndx" type="text" class="required" id="clave_ndx" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);" maxlength="5"></td>
      </tr>
    </table>
</td>
  </tr>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="2" bgcolor="#DCDDDE">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        <td><input class="required" name="clave_nmed" type="text" id="clave_nmed" onKeyUp="conMayusculas(this); solo_letras_numeros(this.value, this.name);" maxlength="5"></td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="4">
      <tr>
        <td width="50%" class="titulosTabs">Concentración</td>
