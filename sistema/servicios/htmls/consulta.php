...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    ...
    <ul style="font-size:0.8em;">
        <li><a class="tabs" id="tabs-1-1" href="#tabs-1" style="color:; font-size:1em;">GENERALES</a></li>
        <li><a class="tabs" id="tabs-6-1" href="#tabs-6" style="color:; font-size:1em;">S-V</a></li>
        <li><a class="tabs" id="tabs-2-1" href="#tabs-2" style="color:; font-size:1em;">H-C</a></li>
        <li><a class="tabs" id="tabs-3-1" href="#tabs-3" style="color:; font-size:1em;">NOTA MÉDICA</a></li>
        <li><a class="tabs" id="tabs-4-1" href="#tabs-4" style="color:; font-size:1em;">RECETA (F)</a></li>
        <li><a class="tabs" id="tabs-7-1" href="#tabs-7" style="color:; font-size:1em;">RECETA (R)</a></li>
        <li><a class="tabs" id="tabs-8-1" href="#tabs-8" style="color:; font-size:1em;">IMÁGENES</a></li>
        <li id="tabRevisiones" style="display:none;"><a class="tabs" id="tabs-5-1" href="#tabs-5" style="color:; font-size:1em;">REVISIONES</a></li>
        <li style="display:none;"><a class="tabs" id="tabs-9-1" href="#tabs-9" style="color:; font-size:1em;">oculta</a></li>
    </ul>
    </td>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="2" id="tablaVideos">
      <tr>
  ...
  <div id="tabs-3" style="width:99%; height:92%; font-size:0.8em; overflow:auto;">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tr>
      	<td align="left"class="titulosTabs"width="100%"nowrap valign="top" style="height:1px;">
        	<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="250" align="left">FECHA <span id="fechaHoraC">15/10/15 22:49</span></td>
                <td align="center">
                	NOTA MÉDICA&nbsp;
        ...
        <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="1">
              <tr height="1">
                <td width="33.3%"><span id="aFC" style="color:#000000;">*</span> FC</td>
              ...
              <tr height="1">
                <td><span id="aFR" style="color:#000000;">*</span> FR</td>
              ...
              <tr height="1">
                <td><span id="aTA" style="color:#000000;">*</span> T/A</td>
              ...
              <tr height="1">
                <td nowrap><span id="aTEMP" style="color:#000000;">*</span> TEMP</td>
              ...
              <tr height="1">
                <td><span id="aPESO" style="color:#000000; display:none;">*</span> PESO</td>
              ...
              <tr height="1">
                <td nowrap><span id="aTALLA" style="color:#000000; display:none;">*</span> TALLA</td>
              ...
              <tr height="1">
                <td><span id="aIMC" style="color:#000000;">*</span> IMC</td>
              ...
              <tr>
                <td colspan="3" valign="top" style="font-size:0.8em; padding:1px;" align="justify">ALÉRGIAS: <span id="alergias0"></span></td>
              </tr>
            </table>
            </td>
            <td>
            <input style="resize:none; text-align:left" name="notaMedicaC" id="notaMedicaC" type="text" value="ESCRIBA AQUÍ LA NOTA MÉDICA" class="jqte-test">
    ...
    <td id="contenedorDatatableDX" valign="top" style=" padding-top:0px;">
      <table width="100%" height="100%" border="0" cellpadding="2" cellspacing="0" id="dataTableDX" class="tablilla">
        <thead id="cabecera_tBusquedaDX" class="miCabeceraDT">
          <tr bgcolor="#FF6633">
            <th style="color:;" id="clickmeDX">#</th>
            <th style="color:;">
  ...
  <div id="tabs-4" style="width:99%; height:91%; font-size:1em;"> 
  <table width="100%" height="95%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="100%" id="contenedorRF" valign="top">
    <table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tr><td align="left"class="titulosTabs"width="100%"nowrap valign="top" style="height:1px;">
      	Receta (frontal). Medicamentos&nbsp;
        <button class="botonC busqueda" name="b_medicamentosC" id="b_medicamentosC">Buscar medicamentos</button>
        <button id="imprimirRecetaF" style="font-size:0.8em; display:none;">Imprimir</button>
      </td></tr>
      <tr>
        <td id="recetaFrontC">
        <!--<input style="resize:none; text-align:left; font-size:10px;" name="recetaFrontC" id="recetaFrontC" type="text" value="" class="jqte-test"> -->
        </td>
      </tr>
      <tr>
        <td id="contenedorIndiF" align="left">Indicaciones:
        	<input style="resize:none; text-align:left" name="indiF" id="indiF" type="text" value="ESCRIBA AQUÍ LAS INDICACIONES" class="jqte-test">
        </td>
      </tr>
    </table>
    </td>
  ...
  <div id="tabs-7" style="width:99%; height:91%; font-size:0.8em;"> 
    <table width="100%" height="100%" border="0" cellspacing="2" cellpadding="2">
      <tr height="1px">
        <td align="left"class="titulosTabs"width="1%"nowrap valign="top">
        	Receta (reverso). Otras indicaciones&nbsp;
  ...
  <ul style="font-size:0.8em;">
      <li><a class="tabs" id="tabs-1-1h" href="#tabs-1h" style="color:; font-size:1em;">CONSULTAS</a></li>
      <li><a class="tabs" id="tabs-2-1h" href="#tabs-2h" style="color:; font-size:1em;">IMAGEN</a></li>
      <li><a class="tabs" id="tabs-3-1h" href="#tabs-3h" style="color:; font-size:1em;">LABORATORIO</a></li>
      <li style="display:none;"><a class="tabs"id="tabs-4-1h" href="#tabs-4h" style="color:; font-size:1em;">ENDOSCOPÍA</a></li>
      <li><a class="tabs" id="tabs-5-1h" href="#tabs-5h" style="color:; font-size:1em;">SERVICIOS</a></li>
  </ul>
  
  <div id="tabs-1h" style="width:99%; height:92%; font-size:0.8em; padding-top:3px;">
  <table width="100%" height="91%" border="0" cellpadding="4" cellspacing="0" id="dataTableHCo" class="tablilla">
  ...
  <div id="tabs-2h" style="width:99%; height:92%; font-size:0.8em; padding-top:3px;">
  <table width="100%" height="91%" border="0" cellpadding="4" cellspacing="0" id="dataTableHIm" class="tablilla">
    <thead id="cabecera_tBusquedaHco" class="miCabeceraDT">
      <tr bgcolor="#FF6633">
  ...
  <div id="tabs-3h" style="width:99%; height:92%; font-size:0.8em; padding-top:3px;">
  ...
  <div id="tabs-4h" style="width:99%; height:92%; font-size:0.8em; padding-top:3px;">
  <table width="100%" height="94%" border="0" cellpadding="4" cellspacing="0" id="dataTableHEn" class="tablilla">
    <thead id="cabecera_tBusquedaHco" class="miCabeceraDT">
      <tr bgcolor="#FF6633">
  ...
  <div id="tabs-5h" style="width:99%; height:92%; font-size:0.8em; padding-top:3px;">
  <table width="100%" height="90%" border="0" cellpadding="4" cellspacing="0" id="dataTableHSe" class="tablilla">
    <thead id="cabecera_tBusquedaHco" class="miCabeceraDT">
      <tr bgcolor="#FF6633">
...
<div id="tabs-6" style="width:99%; height:91%; font-size:0.8em;">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:0.9em;">
  <tr>
    <td>
    <ul>
        <li><a id="tabs-1-1s" href="#tabs-1s" style="color:; font-size:1em;">ÚLTIMOS</a></li>
        <li><a id="tabs-2-1s" href="#tabs-2s" style="color:; font-size:1em;">RIESGOS</a></li>
        <li><a id="tabs-3-1s" href="#tabs-3s" style="color:; font-size:1em;">RECOMENDACIONES</a></li>
        <li><a id="tabs-4-1s" href="#tabs-4s" style="color:; font-size:1em;">HISTORIAL</a></li>
        <li><a id="tabs-5-1s" href="#tabs-5s" style="color:; font-size:1em;">ESTADISTICAS</a></li>
    </ul>
    </td>
  ...
  <div id="tabs-1s" style="width:99%; height:93%; background-color:#DCDDDE;">
  <table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tbody align="left">
      ...
      <tr>
        <td>
        <table width="100%" border="1" cellspacing="0" cellpadding="2" id="tablaSVT">
          <tr> 
          	<td width="25%">
            <table width="100%" border="0" cellspacing="2" cellpadding="2">
              <tr>
...
<div id="tabs-2s" style="width:99%; height:93%; font-size:0.9em; background-color:#DCDDDE;">
...
<div id="tabs-3s" style="width:99%; height:93%; font-size:1.1em; background-color:#DCDDDE;">
<table width="100%" border="0" cellspacing="0" cellpadding="3">
<tr>
	<td align="justify">
...
<tr id="recomendacionOB">
  ...
  <div id="tabs-4s" style="width:99%; height:93%; padding-top:3px; background-color:#DCDDDE;"> 
  ...
  <table width="100%" height="100%" border="0" cellpadding="4" cellspacing="0" id="dataTableSV" class="tablilla">
    <thead id="cabecera_tBusquedaSV">
      <tr bgcolor="#FF6633">
        <th style="color:;" id="clickmeSV" width="1px">#</th>
        <th style="color:;" width="10px">FECHA</th>
        <th style="color:;" nowrap>PESO(kg)</th>
     	<th style="color:;" nowrap>TALLA(mts)</th>
        <th style="color:;" nowrap>IMC(kg/m^2)</th>
		<th style="color:;" nowrap>CINTURA(cm)</th>
        <th style="color:;" nowrap>T/A</th>
		<th style="color:;" nowrap>FR(xMin)</th>
        <th style="color:;" nowrap>FC(xMin)</th>
        <th style="color:;" nowrap>T(ºc)</th>
      </tr>
    </thead>
...
<div id="tabs-5s" style="width:99%; height:93%; padding-top:1px; background-color:#DCDDDE;"> 
