...
require("../../funciones/php/values.php");
 ...
 if(isset($_POST["x"]) and $_POST["x"]==0){		
	...
	mysqli_select_db($horizonte, $database_horizonte);
	$result = mysqli_query($horizonte, "SELECT max(id_vc) from venta_conceptos where id_paciente_vc = $idP and tipo_concepto_vc = 4 and estatus_vc = 5 and id_vc not in ($idE) and area_vc = 58 and temporal_vc = 0 limit 1 ") or die (mysqli_error($horizonte));
