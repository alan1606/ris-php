...
require("../../funciones/php/values.php");
 ...
 //
	...
	$datos = $nombre.';*}-{'.$fx.';*}-{'.$sexo.';*}-{'.$direccionP.';*}-{'.$rowC1[1].';*}-{'.$miFecha.';*}-{'.$row1[0].';*}-{'.$row1[1].';*}-{'.$row1[2].';*}-{'.$row1[3].';*}-{'.$row1[4].';*}-{'.$row1[5].';*}-{'.$row1[6].';*}-{'.$lista/*$rowC1[0]*/.';*}-{'.$alergias.';*}-{'.$doctorcito.';*}-{'.$especialidadDR.';*}-{'.$rowC1[2];
