...
require("../../funciones/php/values.php");
 ...
 mysqli_select_db($horizonte, $database_horizonte); 
 $resultC = mysqli_query($horizonte, "SELECT DATE_FORMAT(fecha_venta_vc,'%d/%c/%Y'), motivo_visita_vc, no_temp_vc from venta_conceptos where id_vc = $idC and tipo_concepto_vc = 2") or die (mysqli_error($horizonte));
...
if (!$update) { echo $sql; }else { echo "1".";*-".$rowC[0].";*-".$rowS[0].";*-".$rowC[1].";*-".$rowC[2].";*-".$nombreP; }
