...
if($checaPro == 1){
	$sql = "UPDATE venta_conceptos SET estatus_vc = 3, usuarioEdo2_e = $idU, fechaEdo2_e = $now, nota_radiologo_vc = $nota where id_vc = $idEvc ";
}elseif($checaPro == 2){
	$sql = "UPDATE venta_conceptos SET estatus_vc = 3, usuarioEdo2_e = $idU, fechaEdo2_e = $now, nota_radiologo_vc = $nota where referencia_vc = $ref and estatus_vc = 2 and area_vc = 55 ";
}
