...
//ESTA PARTE ES LA QUE ENVIA EL ESTUDIO AL PACIENTE Y MEDICO REFERENTE
	...
	window.setTimeout(function(){
		$("#myModal3").load('imagen/htmls/mi_email.php', function(response,status,xhr){if(status == "success"){
			...
			$('#send_mail').click(function(e){
				...
				var datos={emailPaciente:$('#email_pac').val(),link:linki,paciente:paciente,estudio:estudio,body:$('#mensajeE').val(),emailMedReferente:$('#email_pac2').val(),medicoRadiologo:$('#medicoRadiologo').val(),tecnicoEstudio:$('#tecnicoEstudio').val()}
