...
include_once '../../../recursos/utilities.php';
	...
	$aColumns = array('c.id_to', 'c.concepto_to', 'a.nombre_a', 'c.precio_to','c.precio_urgencia_to', 'c.precio_m','c.precio_mu', 'ca.valor_sino','c.id_to');
    ...
    $sIndexColumn = "c.id_to";
	 ...
	 // Joins hasta aqui
	$sJoin = 'left join areas a on a.id_a = c.id_area_to left join catalogo_sino ca on ca.id_sino = c.dicom';
	 
    // CONDITIONS
    $sWhere = "where c.id_tipo_concepto_to = 4 " ;
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		if($acceso_user==1 or $acceso_user==5){
