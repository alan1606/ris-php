...
require("../../../Connections/horizonte.php"); 
	...
	$aColumns = array('c.id_to', 'c.concepto_to', 'a.nombre_a', 'c.precio_to','c.precio_urgencia_to', 'c.precio1_to','c.precio_urgencia1_to', 'c.id_to');
    ...
    */
    ...
    while ( $aRow = mysqli_fetch_array( $rResult ) )
    {
		...
		if($_GET['access']==1){
			$row[1] = "<span id='$row[7]' onClick='verPaciente(this.id);' class='celdas_accion'>$row[1]</span>";
		}
		else{ $row[1]="<span id='$row[7]'>$row[1]</span>"; }
