...
<meta charset="utf-8">
<title>TABULADOR BASE DE ESTUDIOS DE IMAGEN</title>
...
$("#dialog-confirmarNuevoPaciente").load("htmls/ficha_tabulador_base.php",function(response, status, xhr) {
	if ( status == "success" ) { 
			...
			$('#dialog-confirmarNuevoPaciente').dialog({
				...
				"ACTUALIZAR": function() {
					if($('#formEstudio').valid()){
						...
						$.post('files-serverside/updateTab_base.php',datosE).done(function( data ) {
			  ...
			  open:function( event, ui ){ $('#idEstudioE').val(x); $('#formEstudio').validate({ignore: 'hidden'});
					...
					$("#precioE1").val(datosI[5]);$('#precioUrgenciaE1').val(datosI[6]);
...
<div id="header" class="header">
    <table height="100%" width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td align="left" valign="middle"><span id="verMenu" style="cursor:pointer;">TABULADOR BASE DE ESTUDIOS IMAGEN</span></td>
