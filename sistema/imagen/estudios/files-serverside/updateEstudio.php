...
require("../../../funciones/php/values.php");
 ...
 $sql = "UPDATE conceptos set concepto_to = $nombre, precio_to = $precio, precio_urgencia_to = $precioU, id_area_to = $idArea, formato = $formato, dicom = $dicom, precio_m = $precioM, precio_mu = $precioMU where id_to = $idEstudio";
