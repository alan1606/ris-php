...
if($_GET['action'] == 'listFotos1'){
	...
	while($rows = mysqli_fetch_assoc($query)){ $contador++;
		...
		$img = "'imagen/img_colpo/filemanager/source/".$rows['id_estudio_vc_ie']."/".$fotillo[0]."'";
		if($rows['a_reporte_ie']==1){
			...
			<img width="140" height="" onClick="miImg('.$img.')" style="border:1px solid black;cursor:pointer;" src="imagen/img_colpo/filemanager/source/'.$carpeta.'/thumbs/'.$rows['nombre_ie'].'?'.$x.'" />
			</td> </tr> </table>
            ';
			}else{
				echo  '
			...
			</td> </tr> <tr> <td><img width="140" height="" onClick="miImg('.$img.')" style="border:1px solid black;cursor:pointer;" src="imagen/img_colpo/filemanager/source/'.$carpeta.'/thumbs/'.$rows['nombre_ie'].'?'.$x.'" /></td> </tr> </table>
            ';
			}
		}else{
			$resultO = mysqli_query($horizonte, "SELECT estatus_vc from venta_conceptos where id_vc = ".$carpeta." limit 1") or die (mysqli_error($horizonte));
	...
	switch($rowG1[0]){
		case 1:
			...
			<img id="myImg1" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" />
			</td> 
			</tr> </table>
			';
		break;
		case 2:
			...
			<td height="50%" valign="bottom" align="center">
				<img id="myImg2" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" />
			</td> 
			</tr>
			<tr> 
			<td height="50%" valign="top" align="center">
				<img id="myImg3" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" />
			</td> 
			</tr> 
			</table>
			';
		...
		case 3:
			...
			<tr> 
			<td align="center" valign="bottom" height="33.3%"><img id="myImg4" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td> </tr>
			<tr> 
			<td align="center" height="3%"><img id="myImg5" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> </tr> 
			<tr> 
			<td align="center" valign="top" height="33.3%"><img id="myImg6" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td> </tr> 
			</table>
			';
		break;
		case 4:
			...
			<tr> 
				<td width="50%" height="50%" align="center" valign="bottom"><img id="myImg7" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td>
				<td height="" align="center" valign="bottom"><img id="myImg8" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="" align="center" valign="top"><img id="myImg9" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td>
				<td height="" align="center" valign="top"><img id="myImg10" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img4[0].'?'.$x.'" /></td> 
			</tr> 
			</table>
			';
		break;
		case 5:
			...
			<tr> 
				<td height="33.3%" align="right" valign="bottom"><img id="myImg11" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td>
				<td height="33.3%" align="left" valign="bottom"><img id="myImg12" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="1%" align="right" valign="middle"><img id="myImg13" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td>
				<td height="1% align="left" valign="middle">
				<img id="myImg14" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img4[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="33.3%" align="center" valign="top" colspan="2"><img id="myImg15" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img5[0].'?'.$x.'" /></td>
			</tr> 
			</table>
			';
		break;
		case 6:
			...
			<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="2" style=""> 
			<tr> 
				<td height="33.3%" width="50%" align="right" valign="bottom"><img id="myImg16" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td>
				<td height="33.3%" align="left" valign="bottom"><img id="myImg17" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="1%" align="right" valign="middle"><img id="myImg18" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td>
				<td height="" align="left" valign="middle"><img id="myImg19" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img4[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="33.3%" align="right" valign="top"><img id="myImg20" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img5[0].'?'.$x.'" /></td>
				<td height="33.3%" align="left" valign="top"><img id="myImg21" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$img6[0].'?'.$x.'" /></td>
			</tr> 
			</table>
			';
		break;
	...
	while($rows = mysqli_fetch_assoc($query))
    {
		...
		<tr> <td><img width="140" height="" style="border:1px solid black;" src="img_colpo/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" /></td> </tr> </table>
		';
    }*/
    ...
    {
        echo  '
			<img src="imagen/img_colpo/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" data-image="imagen/img_colpo/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" />
            ';
    }
