...
require("../../funciones/php/values.php");
 ...
 //saving mkdir("../img_endo/filemanager/source/".$_POST['id'], 0777);
 ...
 $fileName = '../img_endo/filemanager/source/'.$_POST['id'].'/'.$_POST['cont'].'.png';
 ...
 $sql = "INSERT INTO img_endoscopia (nombre_ie, id_estudio_vc_ie, imagen_ie, a_reporte_ie) VALUES ($nombre_img, $idEstudio, $imagen, 0)";
