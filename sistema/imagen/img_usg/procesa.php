...
if($_GET['action'] == 'listFotos1'){
    ...
    $query = mysqli_query($horizonte, "SELECT id_ie, nombre_ie, imagen_ie, a_reporte_ie, id_estudio_vc_ie FROM img_ultrasonido where id_estudio_vc_ie = $carpeta and tumb_ie = 1 and imagen_ie != 'NaN_1' order by id_ie desc; ");
	while($rows = mysqli_fetch_assoc($query)){ $contador++;
		$fotillo = explode('_1', $rows['nombre_ie']);

		$img = "'imagen/img_usg/filemanager/source/".$rows['id_estudio_vc_ie']."/".$fotillo[0]."'";
		if($rows['a_reporte_ie']==1){
			...
			<table class="table-condensed table-bordered" border="0" cellspacing="0" cellpadding="0" style="float:left">
				...
				<tr>
					<td>
						<img width="140" height="" onClick="miImg('.$img.')" style="border:1px solid black;cursor:pointer;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/thumbs/'.$rows['nombre_ie'].'?'.$x.'" />
					</td>
				</tr>
			</table>
            ';
			...
			</td> </tr> <tr> <td><img width="140" height="" onClick="miImg('.$img.')" style="border:1px solid black;cursor:pointer;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/thumbs/'.$rows['nombre_ie'].'?'.$x.'" /></td> </tr> </table>
            ';
			}
		}else{
	...
	switch($rowG1[0]){
		case 1:
			...
			<img id="myImg1" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" />
			</td> 
			</tr> </table>
			';
		break;
		case 2:
			...
			<td height="50%" valign="bottom" align="center">
				<img id="myImg2" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" />
			</td> 
			</tr>
			<tr> 
			<td height="50%" valign="top" align="center">
				<img id="myImg3" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" />
			</td> 
			</tr> 
			</table>
			';
		...
		case 3:
			...
			<tr> 
			<td align="center" valign="bottom" height="33.3%"><img id="myImg4" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td> </tr>
			<tr> 
			<td align="center" height="3%"><img id="myImg5" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> </tr> 
			<tr> 
			<td align="center" valign="top" height="33.3%"><img id="myImg6" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td> </tr> 
			</table>
			';
		break;
		case 4:
			...
			<tr> 
				<td width="50%" height="50%" align="center" valign="bottom"><img id="myImg7" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td>
				<td height="" align="center" valign="bottom"><img id="myImg8" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="" align="center" valign="top"><img id="myImg9" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td>
				<td height="" align="center" valign="top"><img id="myImg10" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img4[0].'?'.$x.'" /></td> 
			</tr> 
			</table>
			';
		break;
		case 5:
			...
			<tr> 
				<td height="33.3%" align="right" valign="bottom"><img id="myImg11" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td>
				<td height="33.3%" align="left" valign="bottom"><img id="myImg12" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="1%" align="right" valign="middle"><img id="myImg13" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td>
				<td height="1% align="left" valign="middle">
				<img id="myImg14" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img4[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="33.3%" align="center" valign="top" colspan="2"><img id="myImg15" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img5[0].'?'.$x.'" /></td>
			</tr> 
			</table>
			';
		break;
		case 6:
			...
			<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="2" style=""> 
			<tr> 
				<td height="33.3%" width="50%" align="right" valign="bottom"><img id="myImg16" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img1[0].'?'.$x.'" /></td>
				<td height="33.3%" align="left" valign="bottom"><img id="myImg17" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img2[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="1%" align="right" valign="middle"><img id="myImg18" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img3[0].'?'.$x.'" /></td>
				<td height="" align="left" valign="middle"><img id="myImg19" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img4[0].'?'.$x.'" /></td> 
			</tr> 
			<tr> 
				<td height="33.3%" align="right" valign="top"><img id="myImg20" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img5[0].'?'.$x.'" /></td>
				<td height="33.3%" align="left" valign="top"><img id="myImg21" height="" style="border:1px solid black;" src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$img6[0].'?'.$x.'" /></td>
			</tr> 
			</table>
			';
		break;
    ...
    {
        echo  '
			<img src="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" data-image="imagen/img_usg/filemanager/source/'.$carpeta.'/'.$rows['nombre_ie'].'?'.$x.'" />
            ';
    }
	...
	if($reportar==1){
		mysqli_select_db($horizonte, $database_horizonte);
		$queryG = mysqli_query($horizonte, "SELECT id_estudio_vc_ie, nombre_ie FROM img_ultrasonido where id_ie = '".$_POST['id']."' limit 1") or die (mysqli_error($horizonte)); $rowG = mysqli_fetch_row($queryG);
		...
		if($rowG1[0]<7){
			...
			if (file_exists('filemanager/source/'.$rowG[0].'/'.$rowG[1].'')) { //realizamos la copia
				if(copy('filemanager/source/'.$rowG[0].'/'.$rowG[1].'','filemanager/source/'.$rowG[0].'/seleccionadas/'.$rowG[1].'')){}
				else {}
			}else{}
		}else{$update=0;}
	}
		...
		mysqli_select_db($horizonte, $database_horizonte);
		$resultJ = mysqli_query($horizonte, "SELECT id_estudio_vc_ie, nombre_ie FROM img_ultrasonido WHERE id_ie = '".$_POST['id']."' limit 1") or die (mysqli_error($horizonte));
	...
	mysqli_select_db($horizonte, $database_horizonte);
	$queryG1 = mysqli_query($horizonte, "SELECT count(id_ie) FROM img_ultrasonido where id_estudio_vc_ie = $row2[0] and a_reporte_ie = 1 ") or die (mysqli_error($horizonte)); $rowG1 = mysqli_fetch_row($queryG1);
	
	if($rowG1[0]>=6){$juli = 0;}//Ya esta lleno
	else{$juli = 1;}
			
	echo $update.';'.$row2['id_estudio_vc_ie'].';'.$juli;
}
